...
#define USE_HYBRID_FILTER
					...
					shaderPart +=
						...
						"       }                                                                                   \n"
						"#if 0                                                                                      \n"
						"       // interpolate first on T direction, then on S.                                     \n"
						"       vec4 left = mix(t00, t01, ratio.t);                                                 \n"
						"       vec4 right = mix(t10, t11, ratio.t);                                                \n"
						"       return mix(left, right, ratio.s);                                                   \n"
						"#else                                                                                      \n"
						"       // interpolate first on S direction then on T.                                      \n"
						"       vec4 top = mix(t00, t10, ratio.s);                                                  \n"
						"       vec4 bottom = mix(t01, t11, ratio.s);                                               \n"
						"       if (top.a < 1.0f || bottom.a < 1.0f) {                                              \n"
						"           return texel_fetch(tex, rounded_idx, texSize);                                  \n"
						"       }                                                                                   \n"
